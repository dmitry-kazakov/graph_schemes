--                                                                    --
--  package Fuzzy.Graph.Handle.Edit Copyright (c)  Dmitry A. Kazakov  --
--  Interface                                      Luebeck            --
--                                                 Autumn, 2002       --
--                                                                    --
...
--
--  This package provides string I/O for fuzzy graphs.
--
...
package Fuzzy.Graph.Handle.Edit is
--
...
-- maps   unique   feature  names  to  handles.  <classification>  is  a
-- classification as described in Fuzzy.Feature.Handle.Edit. The  syntax
-- depends  on  the  actual  feature  specified  before  (see   <leaf>).
-- <interval>   is   an  interval  of  the  feature  domain  set  values
...
-- is returned as a handle to the root node of created graph. 
-- 
-- Exceptions :
--
