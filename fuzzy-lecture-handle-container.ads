...
--     Fuzzy.Lecture.Handle.Container              Luebeck            --
...
--
--  This  package  provides  sets  of  training  sets  handles.  It   is
--  implemented   through    an    instantiation    of    the    package
--  Object.Handle.Generic_Set.
--
with Ada.Finalization;
with Object.Handle.Generic_Set;

package Fuzzy.Lecture.Handle.Container is
...
--
   procedure Add (Container : in out Set; Item : Lecture_Object_Ptr);
   procedure Add (Container : in out Set; Item : Lecture_Handle);
--
...
--
--    Container - The set
--    Item      - To searched for (pointer, handle, object)
--
...
--
   function Find (Container : Set; Item : Lecture_Object'Class)
      return Integer;
   function Find (Container : Set; Item : Lecture_Object_Ptr)
      return Integer;
   function Find (Container : Set; Item : Lecture_Handle)
      return Integer;
--
...
--
   function Is_In (Container : Set; Item : Lecture_Object'Class)
      return Boolean;
   function Is_In (Container : Set; Item : Lecture_Object_Ptr)
      return Boolean;
   function Is_In (Container : Set; Item : Lecture_Handle)
      return Boolean;
--
...
--
   procedure Remove
             (  Container : in out Set;
                Item      : Lecture_Object'Class
             );
   procedure Remove (Container : in out Set; Item : Lecture_Object_Ptr);
   procedure Remove (Container : in out Set; Item : Lecture_Handle);
--
...
end Fuzzy.Lecture.Handle.Container;
