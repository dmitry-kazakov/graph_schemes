...
<TR><TD valign="top"><b><font color="#808080"><big><big><big>B</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>ased on the intuitionistic fuzzy sets and the possibility theory</b>. Fuzzy 
approach is fully utilized by using intuitionistic sets extended to represent 
not only <i>uncertain</i>, but also <i>contradictory</i> data within same 
...
feasible way.</td>
	...
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>F</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>uzzy features</b>.
...
uncertain, like a temperature said to be <i>n</i> degrees. There could be a 
mixture of both.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
...
<b>uzzy classes</b>. Within this framework classes take a natural 
...
of a classification. Just same as humans do.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>N</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>umeric, enumeration features and features based on linguistic variables</b>. 
The system supports a variety of feature types:
<ul>
<li>Discrete features take values from some crisp finite enumeration set. For 
instance <i>red</i>, <i>green</i>, <i>blue</i>;</li>
<li>The numeric features with integer or real values. Because the system 
consistently rely on fuzzy approach, all numeric features may take standard 
numeric, interval and fuzzy numeric 
values;</li>
<li>Linguistic features taking values from a set of linguistic variables. 
...
triangular, trapezoid, shoulder etc.</li>
</ul>
		</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>U</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>ser-defined features</b>. The system is open for definition of new features 
		beyond built-in classes of numeric, nominal and linguistic ones.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>D</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>erived and evaluated features</b>.
...
other features, using different representations of same features.
	...
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>C</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>lassifiers as features for building hierarchical systems</b>.
...
training higher levels of the system.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><font size="6" color="#808080"><b>A</b></font></TD></TR>
</TABLE>
<b>utomatic refinement in case of dependent features</b>. 
...
used for the teaching and classification.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>I</big></big></big></font></b><font color="#808080">&nbsp;</font></TD></TR>
</TABLE>
<b>ncremental learning</b>.
...
<TR><TD valign="top"><b><font color="#808080"><big><big><big>F</big></big></big></font></b>&nbsp;</TD></TR>
		...
		<b>uzzy control language support</b>.
The includes a compiler of an intuitionistic extension of the Fuzzy Control 
		Language.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>O</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>bject-oriented software design</b>.
The system fully utilizes the advantages 
of modern approach to software architecture and design based on objects.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>F</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>eatures, training sets and classifiers are extensible objects</b>. 
...
implementations or functionality without breaking the existing code.
	...
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>A</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>utomatic garbage collection</b>. The system 
...
more used. This design prevents memory leaks and dandling pointers.
	...
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>G</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>eneric data base support through ODBC</b>. 
...
environment.</td>
	...
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>I/O</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
		<b>facilities</b>. Text I/O is provided for 
teaching sets and classifiers. Teaching sets can be imported in an intuitive 
format from text files.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><font size="6" color="#808080"><b>HTML</b></font></TD></TR>
</TABLE>
		<b>output</b>.
Training sets and classifiers can be output in directly HTML 
format, supporting a web-ready solution.</td>
	</tr>
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>A</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>dvanced graphical user interface</b>.
The graphical user interface is based on GTK+, a cross-platform widget toolkit. 
	...
	<tr>
		<td><TABLE BORDER=0 ALIGN="left" cellspacing="0" cellpadding="0">
<TR><TD valign="top"><b><font color="#808080"><big><big><big>E</big></big></big></font></b>&nbsp;</TD></TR>
</TABLE>
<b>xamples of use</b>.
The system is delivered with an set of samples varying from ones illustrating usage of the system components to examples 
of training on real- life and size data.</td>
	</tr>
</table>

Home page: https://www.dmitry-kazakov.de/ada/fuzzy_ml.htm
