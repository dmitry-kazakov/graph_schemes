...
package body Fuzzy.Graph.Handle.Container is

   procedure Add (Container : in out Set; Item : Graph_Node_Ptr) is
   begin
      Handles_Set.Add (Handles_Set.Set (Container), Item);
   end Add;

   procedure Add (Container : in out Set; Item : Node_Handle) is
   begin
   ...
   procedure Remove (Container : in out Set; Item : Node_Handle) is
   begin
