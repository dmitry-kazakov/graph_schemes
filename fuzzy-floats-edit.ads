--                                                                    --
--  package Fuzzy.Floats.Edit       Copyright (c)  Dmitry A. Kazakov  --
--  Interface                                      Luebeck            --
--                                                 Spring, 2002       --
--                                                                    --
...
-- difference that the domain set values  have  a  form  of  a  floating
...
-- Exceptions:
--
--    Constraint_Error - Not a valid fuzzy number
