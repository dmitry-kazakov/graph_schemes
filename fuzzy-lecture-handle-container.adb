...
package body Fuzzy.Lecture.Handle.Container is

   procedure Add (Container : in out Set; Item : Lecture_Object_Ptr) is
   begin
      Handles_Set.Add (Handles_Set.Set (Container), Item);
   end Add;

   procedure Add (Container : in out Set; Item : Lecture_Handle) is
   begin
   ...
   procedure Remove
             (  Container : in out Set;
                Item      : Lecture_Object_Ptr
             )  is
   begin
      Handles_Set.Remove (Handles_Set.Set (Container), Item);
   end Remove;

   procedure Remove (Container : in out Set; Item : Lecture_Handle) is
   begin
