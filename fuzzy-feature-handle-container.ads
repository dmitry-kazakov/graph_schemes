...
--
--  This package provides sets of feature  handles.  It  is  implemented
--  through an instantiation of the package Object.Handle.Generic_Set.
--
with Object.Handle.Generic_Set;

package Fuzzy.Feature.Handle.Container is
...
--
   procedure Add (Container : in out Set; Item : Feature_Object_Ptr);
   procedure Add (Container : in out Set; Item : Feature_Handle);
--
...
--
   ...
   procedure Remove (Container : in out Set; Item : Feature_Object_Ptr);
   procedure Remove (Container : in out Set; Item : Feature_Handle);
--
