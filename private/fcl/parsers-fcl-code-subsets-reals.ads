...
package Parsers.FCL.Code.Subsets.Reals is
   use Fuzzy.Feature.Domain_Floats.Variable_Measures;
--
-- Set -- Real sets as variables
--
   type Set is new Subset with record
      Value : Variable_Measure;
   end record;
--
-- Get_Set -- Evaluate an expression as a real set
--
--    Tree - The expression
--
-- Returns :
...
--    The result
--
   function Get_Set (Tree : Node'Class) return Set'Class;
--
-- Get_Value_Or_Set -- Evaluate an expression as a real set/value
--
--    Tree - The expression
--
-- This function evaluates Tree as either a real value or a real subset.
-- When the result is a number it is converted to set and then returned.
--
-- Returns :
--
--    The result
--
   function Get_Value_Or_Set (Tree : Node'Class) return Set'Class;
--
