...
--     Persistent.ODBC.Lectures                    Luebeck            --
--  Imaplementation                                Winter, 2002       --
--                                                                    --
--                                Last revision :  16:47 06 Nov 2010  --
--                                                                    --
...
with GNU.DB.SQLCLI.API.Lectures;     use GNU.DB.SQLCLI.API.Lectures;
...
with GNU.DB.SQLCLI.API.Links;
with Strings_Edit.Integers;

package body Persistent.ODBC.Lectures is
   use ID_To_Index_Map;
...
--
   ...
   function Add_Feature
            (  Lesson  : access ODBC_Lecture_Object;
      ...
      if Pointer = Source'Last + 1 then
         ...
         begin
            ...
            begin
               ...
               GNU.DB.SQLCLI.API.Links.Get_References
