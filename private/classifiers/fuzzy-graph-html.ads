...
--
-- This procedure writes the graph rooted in Node into File.  The  color
-- parameters are described in Fuzzy.Feature.HTML for the procedure  Put
-- used for output classifications.  
--
-- Exceptions :
--
