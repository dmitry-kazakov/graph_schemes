...
--     Test_Graph_Schemes.Test_ODBC.Test_2         Luebeck            --
...
separate (Test_Graph_Schemes.Test_ODBC) procedure Test_2 is
   Name    : constant String := "test";
   Storage : Storage_Handle;
   Lesson  : Lecture_Handle;
begin
   Put_Line (File, "<hr><p><b>ODBC Test 2 (lectures)</b></p>");
   Storage := Test_ODBC_Session.Open;
   Dir (File, Storage);
   --
