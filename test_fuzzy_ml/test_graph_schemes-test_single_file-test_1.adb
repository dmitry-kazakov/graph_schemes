...
--     Test_Graph_Schemes.                         Luebeck            --
--        Test_Single_File.Test_1                  Autumn, 2014       --
...
separate (Test_Graph_Schemes.Test_Single_File) procedure Test_1 is
   Storage : constant Storage_Handle := Create ("test.fdb", True);
