...
--     Test_Graph_Schemes.Test_ODBC                Luebeck            --
--  Separate body implementation                   Autumn, 2004       --
--                                                                    --
...
separate (Test_Graph_Schemes)
   procedure Test_ODBC (File : in out File_Type) is
   ...
   procedure Test_Info is separate;
